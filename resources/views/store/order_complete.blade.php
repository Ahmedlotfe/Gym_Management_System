<x-base>
    ...
    <div class="container" style="margin-top: 50px;">
        ...
        <div class="text-center">
            <a href="/store" class="btn btn-success">Shop more</a>
        </div>
    </div>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{ $order_product->product_price * $order_product->quantity }} LE</td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <th class="text-center">{{ $sub_total }} LE</th>
                                                </tr>
                                                <tr>
                                                    <th colspan="2" class="text-right">Tax:</th>
                                                    <th class="text-center">{{ $order->tax }} LE</th>
                                                </tr>

                                                <tr>
                                                    <th colspan="2" class="text-right">Grand Total:</th>
                                                    <th class="text-center">{{ $order->order_total }} LE</th>
                                                </tr>
                                            </tfoot>
                                        </table>
                                    </div>
